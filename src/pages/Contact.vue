          ...
          <div class="card-page">
            <div class="row row-beam-md">
              <div class="col-md-4 text-center py-3 py-md-2">
                ...
                <p class="mb-0">6/161 , Mittal Estate, Sakinaka, Andheri East, Mumbai 400059</p>
              </div>
              <div class="col-md-4 text-center py-3 py-md-2">
                <i class="mai-call-outline h3"></i>
                <p class="fg-primary fw-medium fs-vlarge">Mobile</p>
                <p class="mb-1">+91 9820585461</p>
              </div>
              <div class="col-md-4 text-center py-3 py-md-2">
                <i class="mai-mail-open-outline h3"></i>
                <p class="fg-primary fw-medium fs-vlarge">Email</p>
                <p class="mb-1">support@majix.tech</p>
                <p class="mb-0">hawk@majix.tech</p>
              </div>
            </div>
          </div>
        </div>
