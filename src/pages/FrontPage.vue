    ...
    <div class="row">
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
          <img src="../assets/img/Hawk Customer List.png" alt="">
        </div>
      </div>
    ...
    <div class="row justify-content-center mt-5">
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="1000ms">
          ...
          <p class="fs-large">Continuous Development</p>
          <p class="fs-small fg-grey">We will keep adding more features & reports to make your business boom</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="page-section bg-image bg-image-overlay-dark" :style="{ backgroundImage: 'url(' + require('assets/img/bg_testimonials.jpg') + ')' }">
  <div class="container fg-white">
    <div class="row">
      <div class="col-md-8 col-lg-6 offset-lg-1 wow fadeInUp">
        ...
        <p class="fs-large font-italic">We had multiple files and folders before hawk, with filing and searching being a full time job. With Hawk we can access the samples sent to our customer in seconds and ask for their followup and feedback</p>
        <p class="fs-large fg-grey fw-medium mb-5">Mr. Biyani, Damodar</p>
  ...
  <div class="container">
    <div class="row mb-5 py-3">
      ...
      <div class="col-md-6 col-lg-4 py-3">
        ...
        <ul class="menu-link">
          <li>6/161, Mittal Estate, Sakinaka, Andheri East, Mumbai 400059</li>
          <li>hawk@majix.tech</li>
          <li>support@majix.tech</li>
          <li>+91 98205 85461</li>
        </ul>
      </div>
      <div class="col-md-6 col-lg-4 py-3">
