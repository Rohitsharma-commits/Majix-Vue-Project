        ...
        <div class="col-lg-6">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-dark justify-content-center bg-transparent">
              <li class="breadcrumb-item active" aria-current="page">Updates to Hawk</li>
            </ol>
          </nav>
        </div>
      </div>
...
<div class="page-section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="card-page">
          <h3 class="mb-3">Hawk 0.5.1</h3>
          <p>Hawk 0.5.1 Launches</p>
          <h5>Home Page</h5>
          <ul class="theme-list">
            <li class="list-item">New Home Page</li>
            <li class="list-item">Creation of webpages</li>
          </ul>
          <h5>Functionality</h5>
          <ul class="theme-list">
            <li class="list-item">Improved Reproting</li>
            <li class="list-item">Additional Task features</li>
          </ul>
          <h5>UX / UI</h5>
          <ul class="theme-list">
            <li class="list-item">Minimalistic Color Pallete </li>
            <li class="list-item">Revised Dashboard Design</li>
            <li class="list-item">Improved links</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row mb-5 py-3">
      ...
      <div class="col-md-6 col-lg-4 py-3">
        ...
        <ul class="menu-link">
          ...
          <li><a href="#" class="">support@majix.tech</a></li>
 ...
 */
 .navbar-dark .navbar-nav .nav-link[data-v-4e7146d6] {
    color: rgba(14, 3, 3, 0.5);
  }
  .navbar-dark .navbar-nav .show>.nav-link[data-v-4e7146d6], .navbar-dark .navbar-nav .active>.nav-link[data-v-4e7146d6], .navbar-dark .navbar-nav .nav-link.show[data-v-4e7146d6], .navbar-dark .navbar-nav .nav-link.active[data-v-4e7146d6] {
    color: rgba(14, 3, 3, 0.5);
  }
:root {
  --blue: #007bff;
