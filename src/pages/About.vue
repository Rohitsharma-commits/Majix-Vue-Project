...
<nav class="navbar navbar-expand-lg navbar-dark navbar-floating">
  <div class="container">
    <router-link class="navbar-brand" to="/">
      <img src="../assets/HAWK Favicon.png" alt="" width="40">
    </router-link>
      ...
      <router-link class="nav-link" to="/">Home</router-link>
        ...
        <!-- <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <router-link class="nav-link" style="color:black;" to="/">Hawk</router-link>
            <router-link class="nav-link" style="color:black;" to="/Amaze">Amaze</router-link>
          </div>
        </li> -->
        <li class="nav-item">
        ...
        <div class="col-lg-6">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-dark justify-content-center bg-transparent">
              <li class="breadcrumb-item"><a href="index.html">Majix Computing Pvt Ltd</a></li>
            </ol>
          </nav>
        </div>
      </div>
...
<div class="page-section pt-5">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="card-page">
          <h5 class="fg-primary">Development of our Sample Management Platform</h5>
          <hr>
          <p>Hawk was developed with the single minded goal of improving custumer relationship for MSME's and small firms. With hundreds of weekly inquiries and sampling requirements it is often felt that the ROI on the sampling being done is not got. </p>
          <p>This is where our Sample Management System comes in. With powerful data analytics features this will allow you to harness the power of AI and machine learning to get a complete 360 degree view of all the sampling done. Drill down to each sample sent to customer over the previous quarter or get a bird's eye view of the total number of samples done. This system allows you to create, dispatch , track and analyse data from each sample sent by you.</p>
          ...
          <p>Using our Sample Orders and Task Orders, every custome interaction is tracked and analysed. This application has been created with the focus on industires having physical sample work like textiles.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row mb-5 py-3">
      ...
      <div class="col-md-6 col-lg-4 py-3">
        ...
        <ul class="menu-link">
          <li><a href="#" class="">6/161, Mittal Estate, Sakinaka, Andheri East, Mumbai 400059</a></li>
          <li><a href="#" class="">hawk@majix.tech</a></li>
          <li><a href="#" class="">support@mmajix.tech</a></li>
          <li><a href="#" class="">+91 98205 85461</a></li>
        </ul>
      </div>
      <div class="col-md-6 col-lg-4 py-3">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 py-2">
        ...
        <p class="d-inline-block ml-2">Copyright &copy; Majix Computing Pvt Ltd. All rights reserved</p>
      </div>
      <div class="col-12 col-md-6 py-2">
...
.pricing-item {
  ...
  background-color: #fff;
  background-image: url(~assets/img/pricing_pattern_grayscale.svg);
  background-repeat: no-repeat;
  background-size: cover;
  width: 300px;
  border-radius: 8px;
...
.pricing-item.active {
  background-image: url(~assets/img/pricing_pattern.svg);
}
